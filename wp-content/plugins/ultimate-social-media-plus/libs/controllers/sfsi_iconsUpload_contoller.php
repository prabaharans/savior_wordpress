...
function sfsi_plus_Iamdone()
{
	...
	if(get_option("plus_wechat_skin"))
	 ...
	 if(get_option("plus_mastodon_skin"))
	 {
		$icon = get_option("plus_mastodon_skin");
		$return .= '<span class="sfsiplus_row_17_28 sfsiplus_mastodon_section sfsi_plus-bgimage" style="background: url('.$icon.') no-repeat;"></span>';
	 }else
	 {
		$return .= '<span class="sfsiplus_row_17_28 sfsiplus_mastodon_section" style="background-position:-1115px 0;"></span>';
	 }
