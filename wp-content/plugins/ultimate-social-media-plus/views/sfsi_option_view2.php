...
<div class="tab2">
    ...
    <div class="row sfsiplus_twitter_section">
        ...
        <div class="inr_cont twt_tab_2">
            ...
            <div class= "sfsi_plus_new_prmium_follw">
				<p>
					<b><?php _e( 'New: ', 'ultimate-social-media-plus' ); ?></b><?php _e(  "Tweeting becomes really fun in the Premium Plugin – you can insert tags to automatically pull the title of the story & link to the story, attach pictures & snippets to the Tweets (Twitter cards) and user url-shorteners, all leading to more Tweets and traffic for your site! ", 'ultimate-social-media-plus' ); ?><a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay" onclick="sfsi_plus_open_quick_checkout(event)"  target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=better_tweets&utm_medium=banner" class="sfsi_plus_font_inherit" target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>
			    </p>
			</div>
            <?php } ?>
        </div>
...
<!--MZ CODE START-->	 
	...
	<div class="row sfsiplus_mastodon_section">
		...
		<div class="inr_cont">
			<p class="sfsiLabel infoLabel">
				<?php _e( 'The mastodon icon can perform two actions. Pick below which ones it should perform.', 'ultimate-social-media-plus' ); ?>
			</p>
			<div class="radio_section fb_url ">
	            ...
	            <label class="sfsiLabel">
	        		<?php _e( 'When clicked on users will get directed to your Mastodon page:', 'ultimate-social-media-plus' ); ?>
	        	</label>
